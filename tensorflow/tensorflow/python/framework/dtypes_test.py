...
class TypesTest(test_util.TensorFlowTestCase):
  ...
  def testStringConversion(self):
    ...
    self.assertIs(dtypes.posit16e2, dtypes.as_dtype("posit16e2"))
    self.assertIs(dtypes.posit8e2, dtypes.as_dtype("posit8e2"))
    self.assertIs(dtypes.posit32e2, dtypes.as_dtype("posit32e2"))
    ...
    self.assertIs(dtypes.posit16e2_ref, dtypes.as_dtype("posit16e2_ref"))
    self.assertIs(dtypes.posit8e2_ref, dtypes.as_dtype("posit8e2_ref"))
    self.assertIs(dtypes.posit32e2_ref, dtypes.as_dtype("posit32e2_ref"))
