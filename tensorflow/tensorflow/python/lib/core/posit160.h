...
#ifndef TENSORFLOW_PYTHON_LIB_CORE_POSIT160_H_
#define TENSORFLOW_PYTHON_LIB_CORE_POSIT160_H_
...
int Posit160NumpyType();

}  // namespace tensorflow

#endif  // TENSORFLOW_PYTHON_LIB_CORE_POSIT160_H_
