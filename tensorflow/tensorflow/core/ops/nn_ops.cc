...
REGISTER_OP("FusedBatchNormV2")
    ...
    .Attr("T: {half, bfloat16,posit160, float}")
    .Attr("U: {float}")
    .Attr("epsilon: float = 0.0001")
    .Attr("exponential_avg_factor: float = 1.0")
    .Attr(GetConvnetDataFormatAttrString())
...
REGISTER_OP("_FusedBatchNormEx")
    ...
    .Output("reserve_space_2: U")
    .Output("reserve_space_3: U")
    .Attr("T: {half, float, bfloat16,posit160}")
    .Attr("U: {float}")
    .Attr("epsilon: float = 0.0001")
    .Attr("exponential_avg_factor: float = 1.0")
...
REGISTER_OP("Conv2D")
    ...
    .Input("filter: T")
    .Output("output: T")
    .Attr("T: {half, bfloat16,posit160, float, double, int32}")
...
REGISTER_OP("MaxPool3DGrad")
    ...
    .Attr(GetPaddingAttrString())
    .Attr(GetConvnet3dDataFormatAttrString())
    .Attr("T: {half, bfloat16,posit160, float} = DT_FLOAT")
    .Attr("TInput: {half, bfloat16,posit160, float} = DT_FLOAT")
...
REGISTER_OP("MaxPool")
    .Attr(
        "T: {half, bfloat16,posit160, float, double, int32, int64, uint8, int16, int8, "
...
REGISTER_OP("_MklRelu")
    ...
    .Attr("T: {float, bfloat16,posit160} = DT_FLOAT")
    .SetShapeFn(shape_inference::UnchangedShape)
    .Doc(R"doc(
...
REGISTER_OP("_MklMaxPool")
    .Attr("T: {float, half, bfloat16,posit160} = DT_FLOAT")
    .Attr("ksize: list(int) >= 4")
    .Attr("strides: list(int) >= 4")
    .Attr(GetPaddingAttrString())
    .Attr(GetConvnetDataFormatAttrString())
...
REGISTER_OP("_MklAvgPool")
    ...
    .Attr(GetPaddingAttrString())
    .Attr(GetConvnetDataFormatAttrString())
    .Attr("T: {float, half, double, bfloat16,posit160}")
    .SetShapeFn(shape_inference::AvgPoolShape)
    .Doc(R"doc(
...
REGISTER_OP("_MklToTf")
    ...
    .Input("mkl_input: uint8")
    .Output("output: T")
    .Attr("T: {half, float, double, bfloat16,posit160, qint8, quint8, qint32}")
    .Attr(GetConvnetDataFormat2D3DAttrString())
...
REGISTER_OP("_MklInputConversion")
    ...
    .Attr(
        "T: {half, float, bfloat16,posit160, double, uint8, int8, uint16, int16, int32, "
...
REGISTER_OP("IsotonicRegression")
    ...
    .Attr("T: realnumbertype")
    .Attr("output_dtype: {half, bfloat16,posit160, float, double} = DT_FLOAT")
