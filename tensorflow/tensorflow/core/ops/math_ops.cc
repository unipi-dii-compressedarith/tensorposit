...
REGISTER_OP("BatchMatMul")
    ...
    .Output("output: T")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int32, int64, complex64, "
        "complex128}")
...
REGISTER_OP("BatchMatMulV2")
    ...
    .Output("output: T")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int16, int32, int64, complex64, "
        "complex128}")
    .Attr("adj_x: bool = false")
    .Attr("adj_y: bool = false")
...
REGISTER_OP("BatchMatMulV3")
    ...
    .Output("output: Tout")
    .Attr(
        "Ta: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, uint8, int8, int16, int32, int64, "
        "complex64, complex128}")
    .Attr(
        "Tb: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, uint8, int8, int16, int32, int64, "
        "complex64, complex128}")
    .Attr(
        "Tout: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int16, int32, int64, complex64, "
        "complex128}")
    .Attr("adj_x: bool = false")
    .Attr("adj_y: bool = false")
    .SetShapeFn(shape_inference::BatchMatMulV2Shape);
...
REGISTER_OP("_MklBatchMatMul")
    ...
    .Input("y: T")
    .Output("output: T")
    .Attr("T: {bfloat16, posit16e2, posit32e2, posit8e2, float}")
    .Attr("adj_x: bool = false")
    .Attr("adj_y: bool = false")
    .SetShapeFn(shape_inference::BatchMatMulShape);
...
REGISTER_OP("Abs")
    .Input("x: T")
    .Output("y: T")
    .Attr("T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int8, int16, int32, int64}")
    .SetShapeFn(shape_inference::UnchangedShape);
...
#define UNARY()                                                            \
  Input("x: T")                                                            \
      .Output("y: T")                                                      \
      .Attr(                                                               \
          "T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int8, int16, int32, int64, " \
          "complex64, complex128}")                                        \
      .SetShapeFn(shape_inference::UnchangedShape)
...
#define UNARY_REAL()                              \
  Input("x: T")                                   \
      .Output("y: T")                             \
      .Attr("T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double}") \
      .SetShapeFn(shape_inference::UnchangedShape)

#define UNARY_COMPLEX()                                                  \
  Input("x: T")                                                          \
      .Output("y: T")                                                    \
      .Attr("T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, complex64, complex128}") \
      .SetShapeFn(shape_inference::UnchangedShape)
...
#define BINARY_MORE()                                                          \
  Input("x: T").Input("y: T").Output("z: T").Attr(                             \
      "T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, uint8, int8, uint16, int16, int32, " \
...
REGISTER_OP("Add")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, posit16e2, posit32e2, posit8e2, half, float, double, uint8, int8, int16, int32, int64, "
...
REGISTER_OP("AddV2")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, posit16e2, posit32e2, posit8e2, half, float, double, uint8, uint16, uint32, uint64, "
...
REGISTER_OP("_MklAddV2")
    ...
    .Output("mkl_z: uint8")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, uint8, int8, int16, int32, int64, "
        "complex64, complex128}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn)
    .SetIsAggregate()
    .SetIsCommutative()
...
REGISTER_OP("DivNoNan")
    ...
    .Input("y: T")
    .Output("z: T")
    .Attr("T: {half, posit16e2, posit32e2, posit8e2, float, double, complex64, complex128}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("Maximum")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int8, uint8, int16, uint16, "
...
REGISTER_OP("Mod")
    ...
    .Input("y: T")
    .Output("z: T")
    .Attr("T: {int32, int64, float16, half, bfloat16, posit16e2, posit32e2, posit8e2, float, double}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("FloorMod")
    ...
    .Attr(
        ...
        "bfloat16, posit16e2, posit32e2, posit8e2, half, float, double}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("TruncateMod")
    ...
    .Input("y: T")
    .Output("z: T")
    .Attr("T: {int32, int64, bfloat16,posit16e2, posit32e2, posit8e2, half, float, double}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("Pow")
    ...
    .Output("z: T")
    .Attr(
        "T: {bfloat16, posit16e2, posit32e2, posit8e2, float, half, double, int8, int16, int32, int64, "
        "complex64, complex128}")
    .SetShapeFn(shape_inference::BroadcastBinaryOpShapeFn);
...
REGISTER_OP("Range")
    ...
    .Attr(
        "Tidx: "
        "{bfloat16, posit16e2, posit32e2, posit8e2, half, float, double, int8, int16, int32, int64, uint32} = "
        "DT_INT32")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle unused;
      ...
      } else if (dtype == DT_POSIT162) {
        return RangeSize<posit16e2>(start_t, limit_t, delta_t, c);
      }  else if (dtype == DT_POSIT82) {
        return RangeSize<posit8e2>(start_t, limit_t, delta_t, c);
      } else if (dtype == DT_POSIT322) {
        return RangeSize<posit32e2>(start_t, limit_t, delta_t, c);
      }  else {
