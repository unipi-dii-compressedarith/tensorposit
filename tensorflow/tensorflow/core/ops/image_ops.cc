...
REGISTER_OP("ResizeArea")
    ...
    .Attr(
        ...
        "bfloat16,posit16e2, posit32e2, posit8e2}")
...
REGISTER_OP("ResizeBilinear")
    ...
    .Output("resized_images: float")
    .Attr(
        "T: {int8, uint8, int16, uint16, int32, int64, bfloat16,posit16e2, posit32e2, posit8e2, half, "
        "float, double, bfloat16,posit16e2, posit32e2, posit8e2}")
    .Attr("align_corners: bool = false")
    .Attr("half_pixel_centers: bool = false")
    .SetShapeFn(ResizeShapeFn);
...
REGISTER_OP("ResizeBilinearGrad")
    ...
    .Input("original_image: T")
    .Output("output: T")
    .Attr("T: {float, bfloat16,posit16e2, posit32e2, posit8e2, half, double}")
    .Attr("align_corners: bool = false")
    .Attr("half_pixel_centers: bool = false")
    .SetShapeFn([](InferenceContext* c) {
      c->set_output(0, c->input(1));
...
REGISTER_OP("ResizeNearestNeighbor")
    ...
    .Attr(
        ...
        "double, bfloat16,posit16e2, posit32e2, posit8e2}")
    .Attr("align_corners: bool = false")
    .Attr("half_pixel_centers: bool = false")
    .SetShapeFn(ResizeShapeFn);
...
REGISTER_OP("ResizeNearestNeighborGrad")
    ...
    .Input("size: int32")
    .Output("output: T")
    .Attr("T: {uint8, int8, int32, half, float, double, bfloat16,posit16e2, posit32e2, posit8e2}")
    .Attr("align_corners: bool = false")
    .Attr("half_pixel_centers: bool = false")
    .SetShapeFn([](InferenceContext* c) {
      ShapeHandle input;
