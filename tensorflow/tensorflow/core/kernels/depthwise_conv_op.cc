...
TF_CALL_posit16e2(REGISTER_CPU_KERNEL);
TF_CALL_posit32e2(REGISTER_CPU_KERNEL);
TF_CALL_posit8e2(REGISTER_CPU_KERNEL);
...
TF_CALL_posit16e2(REGISTER_GROUPED_CONV_KERNEL);
TF_CALL_posit32e2(REGISTER_GROUPED_CONV_KERNEL);
TF_CALL_posit8e2(REGISTER_GROUPED_CONV_KERNEL);
