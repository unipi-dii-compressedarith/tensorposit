...
TF_CALL_posit16e2(DECLARE_TYPE);
TF_CALL_posit32e2(DECLARE_TYPE);
TF_CALL_posit8e2(DECLARE_TYPE);
...
#define HANDLE_TYPE_NAME(T) HANDLE_TYPE(DataTypeToEnum<T>::value)
    ...
    TF_CALL_posit16e2(HANDLE_TYPE_NAME);
    TF_CALL_posit32e2(HANDLE_TYPE_NAME);
    TF_CALL_posit8e2(HANDLE_TYPE_NAME);
...
TF_CALL_posit16e2(HANDLE_TYPE_NAME_CPU);
TF_CALL_posit32e2(HANDLE_TYPE_NAME_CPU);
TF_CALL_posit8e2(HANDLE_TYPE_NAME_CPU);
