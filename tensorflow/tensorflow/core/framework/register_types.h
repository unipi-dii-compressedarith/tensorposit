...
#define TF_CALL_posit16e2(m) m(::tensorflow::posit16e2)
#define TF_CALL_posit32e2(m) m(::tensorflow::posit32e2)
#define TF_CALL_posit8e2(m) m(::tensorflow::posit8e2)
...
#define TF_CALL_FLOAT_TYPES(m) \
  TF_CALL_half(m) TF_CALL_bfloat16(m) TF_CALL_posit16e2(m) TF_CALL_posit8e2(m) TF_CALL_posit32e2(m) TF_CALL_float(m) TF_CALL_double(m)
